...
from q_pos.core.models import StrictTimestamp
...
class Business(StrictTimestamp):
        ...
        if kwargs["created"]:
            ...
            if user_type == "MC":
                business = Business.objects.create(
                    merchant=kwargs["instance"],
                    name=kwargs["instance"].firstname,
    ...
    def __str__(self):
        return "<Business name={} merchant={}>".format(
            self.name, self.merchant.firstname
        )
